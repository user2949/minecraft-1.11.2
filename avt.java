...
public class avt extends avu {
	protected static final atl a = alv.l.t();
	protected static final atl b = alv.a.t();
	protected static final atl c = alv.A.t();
	protected static final atl d = alv.cM.t();
	...
	protected void a(
		...
		for (boolean boolean29 = random26.nextInt(6) == 0; integer11 < integer12; integer11++) {
			...
			if (!boolean27 && integer11 == integer28 && float8 > 1.0F && integer12 > 0) {
				this.a(
					random26.nextLong(),
					integer2,
					integer3,
			...
			if (boolean27 || random26.nextInt(4) != 0) {
				...
				if (!(double5 < double20 - 16.0 - double30 * 2.0)
					...
					for (int integer43 = integer36; !boolean42 && integer43 < integer37; integer43++) {
						for (int integer44 = integer40; !boolean42 && integer44 < integer41; integer44++) {
							for (int integer45 = integer39 + 1; !boolean42 && integer45 >= integer38 - 1; integer45--) {
								if (integer45 >= 0 && integer45 < 256) {
									atl atl46 = avp.a(integer43, integer45, integer44);
									if (atl46.v() == alv.i || atl46.v() == alv.j) {
										boolean42 = true;
									}
					...
					if (!boolean42) {
						...
						for (int integer44 = integer36; integer44 < integer37; integer44++) {
							double double45 = ((double)(integer44 + integer2 * 16) + 0.5 - double5) / double30;

							for (int integer47 = integer40; integer47 < integer41; integer47++) {
								double double48 = ((double)(integer47 + integer3 * 16) + 0.5 - double7) / double30;
								boolean boolean50 = false;
								if (double45 * double45 + double48 * double48 < 1.0) {
									for (int integer51 = integer39; integer51 > integer38; integer51--) {
										double double52 = ((double)(integer51 - 1) + 0.5 - double6) / double32;
										if (double52 > -0.7 && double45 * double45 + double52 * double52 + double48 * double48 < 1.0) {
											atl atl54 = avp.a(integer44, integer51, integer47);
											atl atl55 = (atl)Objects.firstNonNull(avp.a(integer44, integer51 + 1, integer47), b);
											if (atl54.v() == alv.c || atl54.v() == alv.bw) {
												boolean50 = true;
											}

											if (this.a(atl54, atl55)) {
												if (integer51 - 1 < 10) {
													avp.a(integer44, integer51, integer47, a);
												} else {
													avp.a(integer44, integer51, integer47, b);
													if (boolean50 && avp.a(integer44, integer51 - 1, integer47).v() == alv.d) {
														a43.c(integer44 + integer2 * 16, 0, integer47 + integer3 * 16);
														avp.a(integer44, integer51 - 1, integer47, this.g.b(a43).r.v().t());
													}
												}
											}
										}
	...
	protected boolean a(atl atl1, atl atl2) {
		if (atl1.v() == alv.b) {
			return true;
		} else if (atl1.v() == alv.d) {
			return true;
		} else if (atl1.v() == alv.c) {
			return true;
		} else if (atl1.v() == alv.cz) {
			return true;
		} else if (atl1.v() == alv.cu) {
			return true;
		} else if (atl1.v() == alv.A) {
			return true;
		} else if (atl1.v() == alv.cM) {
			return true;
		} else if (atl1.v() == alv.bw) {
			return true;
		} else {
			return atl1.v() == alv.aH ? true : (atl1.v() == alv.m || atl1.v() == alv.n) && atl2.a() != azs.h;
		}
	}

	@Override
	protected void a(ajs ajs, int integer2, int integer3, int integer4, int integer5, avp avp) {
		int integer8 = this.f.nextInt(this.f.nextInt(this.f.nextInt(15) + 1) + 1);
		...
		for (int integer9 = 0; integer9 < integer8; integer9++) {
			...
			double double12 = (double)this.f.nextInt(this.f.nextInt(120) + 8);
			...
			for (int integer17 = 0; integer17 < integer16; integer17++) {
				...
				if (this.f.nextInt(10) == 0) {
					float20 *= this.f.nextFloat() * this.f.nextFloat() * 3.0F + 1.0F;
				}

				this.a(this.f.nextLong(), integer4, integer5, avp, double10, double12, double14, float20, float18, float19, 0, 0, 1.0);
			}
		}
	}
}
