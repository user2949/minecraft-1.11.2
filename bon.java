public class bon extends bou {
	private static final kq a = new kq("textures/entity/explosion.png");
	...
	protected bon(bza bza, ajs ajs, double double3, double double4, double double5, double double6, double double7, double double8) {
	...
	public void a(bpy bpy, sn sn, float float3, float float4, float float5, float float6, float float7, float float8) {
		int integer10 = (int)(((float)this.L + float3) * 15.0F / (float)this.M);
		if (integer10 <= 15) {
			this.N.a(a);
			float float11 = (float)(integer10 % 4) / 4.0F;
			float float12 = float11 + 0.24975F;
			float float13 = (float)(integer10 / 4) / 4.0F;
			float float14 = float13 + 0.24975F;
			float float15 = 2.0F * this.O;
			...
			beq.a();
			bpy.a(7, b);
			bpy.b((double)(float16 - float4 * float15 - float7 * float15), (double)(float17 - float5 * float15), (double)(float18 - float6 * float15 - float8 * float15))
	...
	public static class a implements bow {
		...
		public bou a(int integer, ajs ajs, double double3, double double4, double double5, double double6, double double7, double double8, int... arr) {
			return new bon(bes.z().N(), ajs, double3, double4, double5, double6, double7, double8);
		}
	}
}
