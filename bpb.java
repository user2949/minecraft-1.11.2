public class bpb extends bou {
	float a;

	private bpb(ajs ajs, double double2, double double3, double double4, double double5, double double6, double double7) {
		this(ajs, double2, double3, double4, double5, double6, double7, 1.0F);
	}

	protected bpb(ajs ajs, double double2, double double3, double double4, double double5, double double6, double double7, float float8) {
		...
		this.k += double6;
		this.l += double7;
		float float16 = (float)(Math.random() * 0.3F);
		this.A = float16;
		this.B = float16;
		this.C = float16;
		this.y *= 0.75F;
	...
	public static class a implements bow {
		...
		public bou a(int integer, ajs ajs, double double3, double double4, double double5, double double6, double double7, double double8, int... arr) {
			return new bpb(ajs, double3, double4, double5, double6, double7, double8);
		}
	}
}
