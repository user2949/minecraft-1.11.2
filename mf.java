...
public class mf extends ChannelInboundHandlerAdapter {
	...
	public void channelRead(ChannelHandlerContext channelHandlerContext, Object object) throws Exception {
		...
		try {
			try {
				...
				switch (integer8) {
					case 0: {
						a.debug("Ping: (<1.3.x) from {}:{}", new Object[]{inetSocketAddress6.getAddress(), inetSocketAddress6.getPort()});
						String string9 = String.format("%s§%d§%d", minecraftServer7.aj(), minecraftServer7.H(), minecraftServer7.I());
					...
					case 1: {
						...
						a.debug("Ping: (1.4-1.5.x) from {}:{}", new Object[]{inetSocketAddress6.getAddress(), inetSocketAddress6.getPort()});
						String string9 = String.format(
							"§1\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", 127, minecraftServer7.G(), minecraftServer7.aj(), minecraftServer7.H(), minecraftServer7.I()
						);
						this.a(channelHandlerContext, this.a(string9));
						break;
					}
					default:
						...
						boolean9 &= "MC|PingHost".equals(new String(byteBuf4.readBytes(byteBuf4.readShort() * 2).array(), Charsets.UTF_16BE));
						...
						a.debug("Ping: (1.6) from {}:{}", new Object[]{inetSocketAddress6.getAddress(), inetSocketAddress6.getPort()});
