...
public class RealmsClickableScrolledSelectionList {
	private final bgl proxy;

	public RealmsClickableScrolledSelectionList(int integer1, int integer2, int integer3, int integer4, int integer5) {
		this.proxy = new bgl(this, integer1, integer2, integer3, integer4, integer5);
	}
	...
	public void customMouseEvent(int integer1, int integer2, int integer3, float float4, int integer5) {
	}
	...
	public void itemClicked(int integer1, int integer2, int integer3, int integer4, int integer5) {
	}

	public void renderSelected(int integer1, int integer2, int integer3, Tezzelator tezzelator) {
	}

	public void setLeftPos(int integer) {
		this.proxy.i(integer);
	}
}
