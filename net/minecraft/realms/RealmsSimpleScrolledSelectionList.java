...
public class RealmsSimpleScrolledSelectionList {
	private final bgo proxy;

	public RealmsSimpleScrolledSelectionList(int integer1, int integer2, int integer3, int integer4, int integer5) {
		this.proxy = new bgo(this, integer1, integer2, integer3, integer4, integer5);
	}
