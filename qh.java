public class qh implements pd {
	...
	@Override
	public du a(du du) {
		if ("minecraft:potion".equals(du.l("id"))) {
			du du3 = du.o("tag");
			short short4 = du.g("Damage");
			if (!du3.b("Potion", 8)) {
				String string5 = a[short4 & 127];
				du3.a("Potion", string5 == null ? "minecraft:water" : string5);
				du.a("tag", du3);
				if ((short4 & 16384) == 16384) {
					du.a("id", "minecraft:splash_potion");
				}
			}
